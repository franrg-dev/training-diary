                ...
                <div style={{ flex: 1 }}>
                  ...
                  {esCardio ? (
                    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                      {r.duracion && <span><span style={{ fontSize: '18px', fontWeight: '700', color: 'var(--color-acento)' }}>{r.duracion}</span><span style={{ fontSize: '11px', color: 'var(--color-texto-secundario)', marginLeft: '2px' }}>min</span></span>}
                      {r.ritmo    && <span><span style={{ fontSize: '18px', fontWeight: '700', color: 'var(--color-acento)' }}>{r.ritmo}</span><span style={{ fontSize: '11px', color: 'var(--color-texto-secundario)', marginLeft: '2px' }}>{r.modo === 'veces' ? 'Rp/m' : 'Km/h'}</span></span>}
                      {r.volumen  && <span><span style={{ fontSize: '18px', fontWeight: '700', color: 'var(--color-acento)' }}>{r.volumen}</span><span style={{ fontSize: '11px', color: 'var(--color-texto-secundario)', marginLeft: '2px' }}>{r.modo === 'veces' ? 'Rp' : 'Km'}</span></span>}
                    </div>
                  ) : (
                    <div>
                      <span style={{ fontSize: '20px', fontWeight: '700', color: 'var(--color-acento)' }}>{r.peso}</span>
