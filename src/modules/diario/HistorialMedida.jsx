        ...
        return (
          <g key={i}>
            ...
            <text
              ...
              textAnchor="middle"
              fontSize="24"
              fill={esUltimo ? '#f97316' : 'var(--color-texto-secundario)'}
            ...
            <text
              ...
              textAnchor="middle"
              fontSize="22"
              fill={esUltimo ? '#f97316' : 'var(--color-texto-inactivo)'}
            >
        ...
        <div className="app-card">
          ...
          {registros.slice().reverse().map((r, i) => (
            ...
            >
              ...
              <div>
                <span style={{ fontSize: '20px', fontWeight: '700', color: '#f97316' }}>{r.valor}</span>
