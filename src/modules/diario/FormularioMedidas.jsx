    ...
    <div style={{ padding: '0 16px 32px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <input
                ...
                style={{
                  ...
                  borderRadius: '10px',
                  color: valores[campo.id] ? 'var(--color-acento)' : 'var(--color-texto-secundario)',
                  fontSize: '16px',
                  fontWeight: '700',
                  textAlign: 'right',
                  outline: 'none',
      ...
      <div style={{ display: 'flex', gap: '10px', marginTop: '24px' }}>
        ...
        <button
          ...
          style={{ flex: 2, padding: '14px', backgroundColor: 'var(--color-acento)', border: 'none', borderRadius: '14px', color: '#fff', fontSize: '15px', fontWeight: '700', cursor: 'pointer' }}
        >
          Guardar
        </button>
      </div>
